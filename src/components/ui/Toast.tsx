...
export default function Toast() {
  ...
  return (
    <>
      <div
        id="toast-success"
        className="fixed bottom-10 right-5 flex items-center w-full max-w-xs p-2 mb-4 text-gray-500
          bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
        role="alert"
      >
        {message.type === SUCCESS ? (
          <div
            className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500
          ...
          <div
            className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-orange-500
